...
import { Plus, Moon, Sun, Inbox } from "lucide-react";
import {
      ...
      <header className={styles["header-container"]}>
        ...
        <div className={styles["top-nav"]}>
          <div className={styles["nav-left"]}>
            <div className={styles["version-info"]}></div>
            ...
            <div className={styles["button-group"]}>
              ...
              >
                <div className={styles["theme-toggle-track"]}>
                  <div
                    className={`${styles["theme-toggle-thumb"]} ${
                      isDarkMode ? styles["dark"] : styles["light"]
                    }`}
                    style={{
                  ...
                  >
                    ...
                    <svg
                      className={`ml-1 w-4 h-4 transition-transform ${
                        dropdownOpen ? styles["rotate-180"] : styles["rotate-0"]
                      }`}
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="2"
                    ...
                    <div className={styles["user-dropdown-menu"]}>
                      {predefinedUsers.map((predefinedUser) => (
                        <div
                          ...
                          className={
                            styles["user-dropdown-item"] +
                            (user.uid === predefinedUser.uid
                              ? " " + styles["user-dropdown-item-active"]
                              : "")
                          }
                          onClick={() => {
                            console.log(
                        ...
                        >
                          <Avatar>
                            <AvatarImage
                              src={predefinedUser.photoUrl}
                              alt={predefinedUser.displayName}
                            />
                            <AvatarFallback>
                              {predefinedUser.displayName[0]}
                            </AvatarFallback>
                          </Avatar>
